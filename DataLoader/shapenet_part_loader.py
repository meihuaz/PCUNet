...
class PartDataset(data.Dataset):
    def __init__(self, root, npoints=2500, classification=False, class_choice=None, split='train',
                 normalize=True):
...
if __name__ == '__main__':
    dset = PartDataset(root='E:/project/point_cloud/dataset/shapenetcore_partanno_segmentation_benchmark_v0/',
    ...
    dataloader = torch.utils.data.DataLoader(dset, batch_size=8,
